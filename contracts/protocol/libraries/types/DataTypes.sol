...
library DataTypes {
  ...
  struct ReserveData {
    ...
    /**
     * 累计利息指数，用于计算可变利率债务的增长   用户最终还款额=归一化后的借款额度 * (当前可变借款指数 / 借款时的可变借款指数)
     * 为什么要用除法？
  ...
  struct ReserveConfigurationMap {
    ...
    //bit 32-47: Liq. bonus
    //bit 48-55: Decimals  小数位数
    //bit 56: Reserve is active 储备是active状态
    //bit 57: reserve is frozen 储备被冻结
    //bit 58: borrowing is enabled  可借款状态
    //bit 59: stable rate borrowing enabled 允许固定利率借款
    //bit 60-63: reserved  储备量
